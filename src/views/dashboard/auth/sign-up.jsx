              ...
              <Col md={6}>
                <div className="sign-in-from text-center">
                  ...
                  <Form className="mt-5" onSubmit={handleSubmit}>
                    {error && <div className="alert alert-danger">{error.includes("Login failed") ? (
                  <div style={{ color: 'red' }}>Le mot de passe doit contenir au moins 8 caractères</div>
        ) : (
            <div>Échec de la connexion. Vérifiez vos identifiants.</div>
        )}</div>}
