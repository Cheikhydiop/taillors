...
import { searchForUsers } from '../../../data/user.js';
import { loadCurrentUser }  from '../../../data/user.js'
...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (currentUserData) {
        setUserArray([currentUserData]);
        // console.log('Données utilisateur stockées dans le tableau :', [currentUserData]);
      } else {
  ...
  const Data = (Array.isArray(userArray) ? userArray : []).reduce((acc, user) => {
    acc.push({
      ProfileData: user.data // Assurez-vous que 'data' existe et a les propriétés correctes
    });
    return acc;
  }, []);
  ...
  console.log("ddddddddddd",Data); // Vérifiez que Data contient les objets attendus

  const Profile = (Array.isArray(Data) ? Data : []).reduce((acc, data) => {
    return {
      ... data.ProfileData
  ...
  const Post = (Array.isArray(Profile.posts) ? Profile.posts : []).reduce((acc, post) => {
    return {
      id: post.id,
      ...
      <div id="content-page" className="content-inner">
        ...
        <Container className="position-relative p-0">
          <div
            ...
            style={{
              backgroundImage: `url('https://res.cloudinary.com/dtossohz4/image/upload/v1728401433/IMG-20240429-WA0049_amnxr1.jpg')`,
                    ...
                    <Row className="align-items-center item-header-content">
                        ...
                        <ul className="d-flex align-items-center justify-content-center gap-3 list-inline p-0 m-0 mb-3 flex-wrap">
                          ...
                          <li className="d-flex align-items-center gap-1">
                            <img
                              ...
                              loading="lazy"
                            />
                            <h6 className="font-size-14 fw-semibold">{Post.reactionCount} j'aimes</h6>
                          </li>
                        </ul>
                      ...
                      <Col lg={4} className="profile-right">
                        <ul className="user-meta list-inline p-0 d-flex align-items-center justify-content-center">
                          <li>
                            <h5>{Profile.postsCount}</h5>Posts
                          </li>
                          <li>
                            <h5>{Post.commentsCount}</h5>Comments
                          </li>
                          <li>
                            <h5>{Post.viewsCount}K</h5>Views
                          </li>
                        </ul>
                      </Col>
                    </Row>
